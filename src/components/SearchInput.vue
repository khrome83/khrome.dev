<template>
  <div class="relative">
    ...
    <div class="relative ml-auto mr-auto w-64 lg:w-80">
      <input
        type="text"
        placeholder="Search (Press  &quot;/&quot; to focus)"
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-orange-500 w-64 lg:w-80"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
      ...
      />
      <div
        class="absolute top-0 ml-auto mr-auto w-64 lg:w-80 pl-3 pointer-events-none"
        style="top:10px"
      >
        <svg
          fill="currentColor"
    ...
    <transition name="fade">
      <div
        ...
        class="normal-case absolute border left-0 right-0 w-108 text-left mb-4 mt-2 rounded-lg shadow overflow-hidden z-10 overflow-y-auto bg-white"
      ...
      >
        <div class="flex flex-col" ref="results">
          <a
            ...
            :href="post.item.path"
            @click="reset"
            class="bg-background-form border-b border-gray-400 text-xl cursor-pointer p-4 search-hover hover:bg-gray-100"
