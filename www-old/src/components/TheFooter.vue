  ...
  <footer class="bg-white text-black">
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
      ...
      <ul class="flex items-center">
        <li class="mr-8">
          <a href="https://twitter.com/khromedotdev" rel="me" target="_blank" class="hover:text-black">
        ...
        <li class="mr-8">
          <a href="https://github.com/khrome83" rel="me" target="_blank" class="hover:text-black">
